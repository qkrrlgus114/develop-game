  ...
  return (
    <main className="page-shell">
      ...
      <section className="two-column-grid">
        <NeoBureauPanel title="실제 방해 요소" eyebrow="Real blocker">
        ...
        <NeoBureauPanel title="가짜 팝업" eyebrow="Fake popup">
          <ul className="bullet-list">
      ...
      <section className="three-column-grid">
        <NeoBureauPanel title="승리" eyebrow="Goal">
          <p>체크리스트를 완료하고 필수 실제 방해 요소를 모두 해결하세요.</p>
        </NeoBureauPanel>
        <NeoBureauPanel title="실패" eyebrow="Fail states">
          <p>시간 초과, 스트라이크 초과, 또는 실제 방해 요소 미처리 상태로 마지막 단계 시도.</p>
        </NeoBureauPanel>
        <NeoBureauPanel title="힌트" eyebrow="Beginner aid">
          <p>쉬움 미션은 초반 힌트 문구를 제공해 첫 세션에서 규칙을 이해하도록 돕습니다.</p>
        </NeoBureauPanel>
      </section>

      <div className="page-actions">
        <NeoBureauButton>미션 선택으로 이동</NeoBureauButton>
      </div>
    </main>
  );
}
